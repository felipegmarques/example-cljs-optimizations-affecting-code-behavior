...
var seq__7986_7990 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__7987_7991 = null;
var count__7988_7992 = (0);
var i__7989_7993 = (0);
while(true){
if((i__7989_7993 < count__7988_7992)){
var str_7994 = cljs.core._nth.call(null,chunk__7987_7991,i__7989_7993);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_7994})));


var G__7995 = seq__7986_7990;
var G__7996 = chunk__7987_7991;
var G__7997 = count__7988_7992;
var G__7998 = (i__7989_7993 + (1));
seq__7986_7990 = G__7995;
chunk__7987_7991 = G__7996;
count__7988_7992 = G__7997;
i__7989_7993 = G__7998;
continue;
} else {
var temp__5735__auto___7999 = cljs.core.seq.call(null,seq__7986_7990);
if(temp__5735__auto___7999){
var seq__7986_8000__$1 = temp__5735__auto___7999;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__7986_8000__$1)){
var c__4556__auto___8001 = cljs.core.chunk_first.call(null,seq__7986_8000__$1);
var G__8002 = cljs.core.chunk_rest.call(null,seq__7986_8000__$1);
var G__8003 = c__4556__auto___8001;
var G__8004 = cljs.core.count.call(null,c__4556__auto___8001);
var G__8005 = (0);
seq__7986_7990 = G__8002;
chunk__7987_7991 = G__8003;
count__7988_7992 = G__8004;
i__7989_7993 = G__8005;
continue;
} else {
var str_8006 = cljs.core.first.call(null,seq__7986_8000__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_8006})));


var G__8007 = cljs.core.next.call(null,seq__7986_8000__$1);
var G__8008 = null;
var G__8009 = (0);
var G__8010 = (0);
seq__7986_7990 = G__8007;
chunk__7987_7991 = G__8008;
count__7988_7992 = G__8009;
i__7989_7993 = G__8010;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__8015 = script;
goog.object.set(G__8015,"type","text/javascript");

goog.object.set(G__8015,"onload",onload);

goog.object.set(G__8015,"onreadystatechange",onload);

return G__8015;
})();
if((opt_sourceText == null)){
var G__8016 = script__$1;
goog.object.set(G__8016,"src",src);

return G__8016;
} else {
var G__8017 = script__$1;
goog.dom.setTextContent(G__8017,opt_sourceText);
...
var path_8018 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_8018);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_8018)].join(''));
} else {
var path_8019 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_8019);

goog.object.remove(goog.dependencies_.written,path_8019);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_8019)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__8020 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__8021 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__8021);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__8020);
}})()})));
}));
