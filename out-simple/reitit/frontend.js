...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,cljs.core.keyword,(function (p1__6413_SHARP_){
return reitit.frontend.query_param.call(null,q,p1__6413_SHARP_);
})),q.getKeys()));
});
/**
...
if(cljs.core.every_QMARK_.call(null,(function (p1__6420_SHARP_){
return cljs.core.contains_QMARK_.call(null,path_params,p1__6420_SHARP_);
