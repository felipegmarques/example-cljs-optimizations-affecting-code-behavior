...
var G__874 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__874;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__875 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__875,ch);
...
if(("\\" === ch__$1)){
var ch_876__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_876__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_876__$2);
} else {
}

var G__877 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__877;
continue;
}
}
...
var vec__885 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__885,(0),null);
var start_column = cljs.core.nth.call(null,vec__885,(1),null);
...
var G__888 = cljs.core.conj_BANG_.call(null,a,form);
a = G__888;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__889 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__890 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__890);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__889);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__891 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__891,(0),null);
var start_column = cljs.core.nth.call(null,vec__891,(1),null);
...
var vec__894 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__894,(0),null);
var end_column = cljs.core.nth.call(null,vec__894,(1),null);
...
var vec__897 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__897,(0),null);
var start_column = cljs.core.nth.call(null,vec__897,(1),null);
...
var vec__900 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__900,(0),null);
var end_column = cljs.core.nth.call(null,vec__900,(1),null);
...
var vec__903 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__903,(0),null);
var start_column = cljs.core.nth.call(null,vec__903,(1),null);
...
var vec__906 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__906,(0),null);
var end_column = cljs.core.nth.call(null,vec__906,(1),null);
...
var sb = (function (){var G__909 = (new goog.string.StringBuffer());
G__909.append(initch);
...
var G__911 = (function (){var G__910 = sb;
G__910.append(ch);

return G__910;
})();
var G__912 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__911;
ch = G__912;
continue;
}
...
switch (G__915) {
case "\\":
var G__919 = (function (){var G__916 = sb;
G__916.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__916;
})();
var G__920 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__919;
ch = G__920;
continue;
...
break;
default:
var G__921 = (function (){var G__917 = sb;
G__917.append(ch);
...
var vec__923 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__923,(0),null);
var end_column = cljs.core.nth.call(null,vec__923,(1),null);
...
var vec__926 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__926,(0),null);
var column = cljs.core.nth.call(null,vec__926,(1),null);
...
var vec__931 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__931,(0),null);
var column = cljs.core.nth.call(null,vec__931,(1),null);
...
var vec__936 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__936,(0),null);
var column = cljs.core.nth.call(null,vec__936,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__941 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__941,(0),null);
var start_column = cljs.core.nth.call(null,vec__941,(1),null);
...
var vec__944 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__944,(0),null);
var end_column = cljs.core.nth.call(null,vec__944,(1),null);
...
var G__947 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__947,true,null,opts,pending_forms);
...
var G__948 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__948)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__948)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__948)){
...
var _STAR_suppress_read_STAR__orig_val__949 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__950 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__950);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__949);
}});
...
var G__951 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__951,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__951,rdr,first_line);
...
var G__955 = matched;
var G__956 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__955;
finished = G__956;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__957 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__958 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__958);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__957);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__959 = cljs.tools.reader.arg_env;
var arg_env_temp_val__960 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__960);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__961 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__961,"(");
...
var G__962 = (i + (1));
var G__963 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__959);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__964 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__964);
...
var G__965 = cljs.core.next.call(null,s__$1);
var G__966 = ret;
s__$1 = G__965;
r = G__966;
continue;
...
var G__967 = cljs.core.next.call(null,s);
var G__968 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__967;
key_vals = G__968;
continue;
} else {
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__975 = token;
var G__975__$1 = (((G__975 == null))?null:cljs.core.subs.call(null,G__975,(1)));
var G__975__$2 = (((G__975__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__975__$1));
var G__975__$3 = (((G__975__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__975__$2));
var G__975__$4 = (((G__975__$3 == null))?null:cljs.core.symbol.call(null,G__975__$3));
if((G__975__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__975__$4);
}
})():(function (){var G__976 = token;
var G__976__$1 = (((G__976 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__976));
if((G__976__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__976__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
}catch (e983){if((e983 instanceof Error)){
var e = e983;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__987,reader){
var map__988 = p__987;
...
var opts = map__988__$1;
var eof = cljs.core.get.call(null,map__988__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
