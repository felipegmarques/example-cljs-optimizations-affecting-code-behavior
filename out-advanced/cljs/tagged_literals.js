...
try{var fexpr__3560 = new cljs.core.Var(function(){return cljs.reader.read_date;},cljs.core.cst$sym$cljs$reader_SLASH_read_DASH_date,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$private,cljs.core.cst$kw$ns,cljs.core.cst$kw$name,cljs.core.cst$kw$file,cljs.core.cst$kw$end_DASH_column,cljs.core.cst$kw$column,cljs.core.cst$kw$line,cljs.core.cst$kw$end_DASH_line,cljs.core.cst$kw$arglists,cljs.core.cst$kw$doc,cljs.core.cst$kw$test],[true,cljs.core.cst$sym$cljs$reader,cljs.core.cst$sym$read_DASH_date,"/Users/felipe.marques/.cljs/.aot_cache/1.10.773/1E96CE3/cljs/reader.cljs",26,1,92,92,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$s], null)),null,(cljs.core.truth_(cljs.reader.read_date)?cljs.reader.read_date.cljs$lang$test:null)]));
return (fexpr__3560.cljs$core$IFn$_invoke$arity$1 ? fexpr__3560.cljs$core$IFn$_invoke$arity$1(form) : fexpr__3560.call(null,form));
}catch (e3559){var e = e3559;
throw (new Error(e.message));
}});
