...
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(subspecs),(1))) && (spec_tools.json_schema.only_entry_QMARK_(cljs.core.cst$kw$allOf,spec)))){
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$default,cljs.core.cst$kw$spec_DASH_tools$json_DASH_schema_SLASH_default], null),cljs.core.cst$kw$hierarchy,(function (){var fexpr__6457 = cljs.core.get_global_hierarchy;
return (fexpr__6457.cljs$core$IFn$_invoke$arity$0 ? fexpr__6457.cljs$core$IFn$_invoke$arity$0() : fexpr__6457.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("spec-tools.json-schema","accept-spec"),spec_tools.json_schema.spec_dispatch,cljs.core.cst$kw$spec_DASH_tools$json_DASH_schema_SLASH_default,hierarchy__4623__auto__,method_table__4619__auto__,prefer_table__4620__auto__,method_cache__4621__auto__,cached_hierarchy__4622__auto__));
})();
}
...
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$clojure$core_SLASH_bytes_QMARK_,(function (_,___$1,___$2,___$3){
...
return (!(cljs.core.cst$kw$infer_DASH_titles.cljs$core$IFn$_invoke$arity$1(options__$1) === false));
});
...
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$clojure$spec$alpha_SLASH_keys,(function (_,spec,children,options){
var map__6461 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__6461__$1 = (((((!((map__6461 == null))))?(((((map__6461.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6461.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6461):map__6461);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6461__$1,cljs.core.cst$kw$req);
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6461__$1,cljs.core.cst$kw$req_DASH_un);
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6461__$1,cljs.core.cst$kw$opt);
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6461__$1,cljs.core.cst$kw$opt_DASH_un);
...
return spec_tools.json_schema.maybe_with_title(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,"object",cljs.core.cst$kw$properties,cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.merge,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$properties,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(children,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$anyOf,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([children], 0)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$allOf,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([children], 0))], 0)))),cljs.core.cst$kw$required,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.sorted_set(),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$required,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(children,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$allOf,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([children], 0))))))], null),spec,options);
});
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$clojure$spec$alpha_SLASH_merge,(function (_,spec,children,options){
return spec_tools.json_schema.accept_merge(children,spec,options);
}));
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$spec_DASH_tools$core_SLASH_merge,(function (_,spec,children,options){
return spec_tools.json_schema.accept_merge(children,spec,options);
}));
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$clojure$spec$alpha_SLASH_every,(function (_,spec,children,options){
var form = spec_tools.impl.extract_form(spec);
var map__6463 = spec_tools.parse.parse_spec(form);
var map__6463__$1 = (((((!((map__6463 == null))))?(((((map__6463.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6463.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6463):map__6463);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6463__$1,cljs.core.cst$kw$type);
var G__6465 = type;
var G__6465__$1 = (((G__6465 instanceof cljs.core.Keyword))?G__6465.fqn:null);
switch (G__6465__$1) {
case "map":
return spec_tools.json_schema.maybe_with_title(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,"object",cljs.core.cst$kw$additionalProperties,spec_tools.impl.unwrap(children)], null),spec,options);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6465__$1)].join('')));

}
}));
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$clojure$spec$alpha_SLASH_every_DASH_kv,(function (_,spec,children,options){
return spec_tools.json_schema.maybe_with_title(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,"object",cljs.core.cst$kw$additionalProperties,cljs.core.second(children)], null),spec,options);
}));
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$spec_DASH_tools$visitor_SLASH_map_DASH_of,(function (_,spec,children,options){
return spec_tools.json_schema.maybe_with_title(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,"object",cljs.core.cst$kw$additionalProperties,cljs.core.second(children)], null),spec,options);
}));
...
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$clojure$spec$alpha_SLASH_alt,(function (_,spec,children,options){
return spec_tools.json_schema.maybe_with_title(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$anyOf,children], null),spec,options);
}));
spec_tools.json_schema.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$clojure$spec$alpha_SLASH_cat,(function (_,spec,children,options){
return spec_tools.json_schema.maybe_with_title(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,"array",cljs.core.cst$kw$items,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$anyOf,children], null)], null),spec,options);
}));
...
var vec__6467 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6467,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6467,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6467,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6467,(3),null);
...
var vec__6470 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6470,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6470,(1),null);
...
var extra_info = (function (){var G__6473 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$description], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6473,cljs.core.cst$kw$title,spec_tools.impl.qualified_name(name));
} else {
return G__6473;
}
})();
var or__4126__auto__ = cljs.core.cst$kw$json_DASH_schema.cljs$core$IFn$_invoke$arity$1(data);
